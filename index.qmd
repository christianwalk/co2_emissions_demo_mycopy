...
```{python}
# Load the data
emissions = pd.read_csv("D:\Graph_Courses_Python\data\co2_cons.csv")
emissions
```
...
table_df=emissions[["country",  "2000", "2021", "2022"]]
table_df
```
...
table_df["Relative Change"] = (table_df["Absolute Change"]/ table_df["2022"])*100
table_df
```
...
emissions_long = emissions.melt(id_vars=["country"], var_name="year",
...
emissions_long_subset = emissions_long_1990_2022.query("country == ['Uganda', 'Kenya', 'Tanzania', 'Congo']")
